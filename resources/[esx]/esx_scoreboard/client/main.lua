...
RegisterNetEvent('esx_scoreboard:Murija')
AddEventHandler('esx_scoreboard:Murija', function(br)
	Policija = br
end)

RegisterNetEvent('esx_scoreboard:Murija2')
AddEventHandler('esx_scoreboard:Murija2', function(br)
	Swat = br
end)
...
function UpdatePlayerTable(connectedPlayers)
	...
	SendNUIMessage({
		...
		jobs   = {ems = ems, police = Policija, taxi = taxi, mechanic = mechanic, cardealer = cardealer, estate = estate, player_count = players}
	})
end
