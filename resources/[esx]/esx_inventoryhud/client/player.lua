...
RegisterNUICallback(
    ...
    function(data, cb)
        ...
        if type(data.number) == "number" and math.floor(data.number) == data.number then
            ...
            TriggerServerEvent("inventory:tradetuljana", GetPlayerServerId(PlayerId()), targetPlayer, data.item.type, data.item.name, count)
        end
...
RegisterNUICallback(
    ...
    function(data, cb)
        ...
        if type(data.number) == "number" and math.floor(data.number) == data.number then
            ...
            TriggerServerEvent("inventory:tradetuljana", targetPlayer, GetPlayerServerId(PlayerId()), data.item.type, data.item.name, count)
        end
