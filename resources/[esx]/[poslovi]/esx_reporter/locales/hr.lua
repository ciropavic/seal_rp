Locales['hr'] = {
  ...
  ['no_outfit'] = 'nemate odjece',
  -- Armory
  ['get_weapon'] = 'uzmi Oruzje',
  ['put_weapon'] = 'ostavi Oruzje',
  ['buy_weapons'] = 'kupi Oruzje',
  ['armory'] = 'Sef',
  ['open_armory'] = 'pritisni ~INPUT_CONTEXT~ da pristupis sefu',
  -- Vehicles
  ['vehicle_menu'] = 'vozila',
  ...
  ['open_bossmenu'] = 'pritisni ~INPUT_CONTEXT~ za otvorit menu',
