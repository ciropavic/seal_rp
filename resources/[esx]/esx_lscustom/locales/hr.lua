Locales['hr'] = {
  ['by_default'] = 'standardno',
  ['installed'] = 'instalirano',
  ['already_own'] = 'vec imas: ~b~%s~s~',
  ['not_enough_money'] = 'nemate novca za ovaj mod!',
...
-- License Plates
  ['blue_on_white_1'] = 'plavo na bijelo 1',
  ['yellow_on_black'] = 'zuto na crno',
  ['yellow_blue'] = 'zuto na plavo',
  ['blue_on_white_2'] = 'plavo na bijelo 2',
  ['blue_on_white_3'] = 'plavo na bijelo 3',
-- Upgrades
  ['upgrades'] = 'nadogradnje',
  ['engine'] = 'motor',
  ['brakes'] = 'kocnice',
  ['transmission'] = 'mjenjac',
...
-- Cosmetics
  ['cosmetics'] = 'kozmetika',
  -- Body Parts
  ['bodyparts'] = 'dijelovi auta',
  ['leftfender'] = 'lijevi blatobran',
  ...
  -- Misc
  ['headlights'] = 'svijetla',
  ['licenseplates'] = 'tablica',
  ['windowtint'] = 'boja prozora',
  ['horns'] = 'trube',
  -- Neon
  ['neons'] = 'neon',
  -- Wheels
  ...
  ['modplateholder'] = 'tablica - Zadnja',
  ['modvanityplate'] = 'tablica - Prednja',
  ['interior'] = 'interior',
  ['trim'] = 'trim',
  ...
  ['air_filter'] = 'zracni filter',
  ['struts'] = 'podupiraci',
  ['arch_cover'] = 'arch cover',
  ['aerials'] = 'antene',
  ['wings'] = 'wings',
  ['fuel_tank'] = 'tank goriva',
  ['windows'] = 'prozori',
  ['stickers'] = 'stikeri',
}
