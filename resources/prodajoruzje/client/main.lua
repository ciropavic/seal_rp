...
local prop_ent = nil
RegisterCommand("testkolica", function(source, args, rawCommandString)
	...
	ESX.Streaming.RequestModel(modele)
	prop_ent = CreateObject(GetHashKey(modele), GetOffsetFromEntityInWorldCoords(PlayerPedId(), 0.0, 0.0, -5.0), true, false, false)--z
...
local kut = nil
RegisterCommand("testkutija", function(source, args, rawCommandString)
	if kut ~= nil then
		DeleteObject(kut)
	end
	local modele = "ng_proc_box_01a"
	ESX.Streaming.RequestModel(modele)
	--Doljnji red
	...
	kut = CreateObject(GetHashKey(modele), GetOffsetFromEntityInWorldCoords(PlayerPedId(), 0.0, 0.0, -5.0), true, false, false)--z
	AttachEntityToEntity(kut, prop_ent, -1, 0, 0.0, 0.28, 0.0, 0, 90.0, false, false, false, false, 0, true)
	...
	--Gornji red
	kut = CreateObject(GetHashKey(modele), GetOffsetFromEntityInWorldCoords(PlayerPedId(), 0.0, 0.0, -5.0), true, false, false)--z
	AttachEntityToEntity(kut, prop_ent, -1, 0, 0.4, 0.62, 0.0, 0, 90.0, false, false, false, false, 0, true)

	kut = CreateObject(GetHashKey(modele), GetOffsetFromEntityInWorldCoords(PlayerPedId(), 0.0, 0.0, -5.0), true, false, false)--z
	AttachEntityToEntity(kut, prop_ent, -1, 0, 0.0, 0.62, 0.0, 0, 90.0, false, false, false, false, 0, true)
...
RegisterCommand("rkolica", function(source, args, rawCommandString)
	if prop_ent ~= nil then
		DeleteObject(prop_ent)
		prop_ent = nil
	end
