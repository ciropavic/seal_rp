...
Radio.Labels = {        
	{ "FRZL_RADIO_HELP", "~s~" .. (radioConfig.Controls.Secondary.Enabled and "~" .. radioConfig.Controls.Secondary.Name .. "~ + ~" .. radioConfig.Controls.Activator.Name .. "~" or "~" .. radioConfig.Controls.Activator.Name .. "~") .. " Zatvori radio.~n~~" .. radioConfig.Controls.Toggle.Name .. "~ da ~g~upalite~s~ radio.~n~~" .. radioConfig.Controls.Decrease.Name .. "~ ili ~" .. radioConfig.Controls.Increase.Name .. "~ da promjenite frekvenciju~n~~" .. radioConfig.Controls.Input.Name .. "~ da izaberete frekvenciju~n~~" .. radioConfig.Controls.ToggleClicks.Name .. "~ da ~a~ zvuk mikrofona~n~Frekvencija: ~1~ MHz" },
	{ "FRZL_RADIO_HELP2", "~s~" .. (radioConfig.Controls.Secondary.Enabled and "~" .. radioConfig.Controls.Secondary.Name .. "~ + ~" .. radioConfig.Controls.Activator.Name .. "~" or "~" .. radioConfig.Controls.Activator.Name .. "~") .. " Zatvori radio.~n~~" .. radioConfig.Controls.Toggle.Name .. "~ da ~r~ugasite~s~ radio.~n~~" .. radioConfig.Controls.Broadcast.Name .. "~ da pricate.~n~Frekvencija: ~1~ MHz" },
	{ "FRZL_RADIO_INPUT", "Unesite frekvenciju" },
}
Radio.Commands = {
	{
