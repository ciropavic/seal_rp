...
mumbleConfig = {
	...
	voiceModes = {
		{2.5, "Saptanje"}, -- Whisper speech distance in gta distance units
		{8.0, "Normalno"}, -- Normal speech distance in gta distance units
		{20.0, "Vristanje"}, -- Shout speech distance in gta distance units
	},
